...
// - Smoother Asteroid Shapes (Less Spiky) // NEW
// ... (rest of features) ...
// --------------------------
...
function displayLeaderboardScreen() {
    ...
    let hover = !isMobile && (mouseX > backButton.x && mouseX < backButton.x + backButton.w && mouseY > button.y && mouseY < button.y + button.h);
